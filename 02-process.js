...
const drugFile = fs.createReadStream(path.join(__dirname, 'data','02','med-events.txt'));
const otherFile = fs.createReadStream(path.join(__dirname, 'data','02','other-events.txt'));

const outputStream = fs.createWriteStream(path.join(__dirname, 'data','02','processed-events.txt'));
